...
- (void) drawCoordinate
{
    ...
    for (int i = 1; i <= hCount; i++) {
        ...
        [str drawInRect:CGRectMake(x + i*(stepWidthH) - 10, y - 15 , 20, 10) withFont:[UIFont systemFontOfSize:8.5f] lineBreakMode:NSLineBreakByCharWrapping alignment:NSTextAlignmentCenter];
    }
...
- (void) drawArea
{
    ...
    for (int i = 0 ; i <_datas.count ; i++) {
        ...
        CGContextSetRGBFillColor(context, 1.0 - 0.05*i, 0.05*i, 0, 1.0);
